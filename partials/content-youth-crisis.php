<!-- main body container -->
<div id="main_container" class="grid-container full-width youth-suicide">

  <!-- featured area - large -->
  <div class="grid-x grid-padding-x featured-img-block show-for-large">
  ...
  <!-- featured area - small -->
  <div class="grid-x grid-padding-x featured-img-block-sm show-for-small-only">
    <div class="large-12 cell">
      <img src="https://cronkitenews.azpbs.org/wp-content/uploads/2018/03/qchs-1800500.jpg" />
    </div>
  </div>
</div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="large-12 cell">
      <div class="single-story">
        <h1 class="text-center">Youths at Risk</h1>
        <p>Cronkite News will spend the next year covering youth suicide. Suicide has become the second-leading cause of death among young people ages 15 to 24 in America, according to the <a href="https://www.cdc.gov/nchs/products/databriefs/db352.htm" target="_blank">Centers for Disease Control and Prevention</a>. And in Arizona, the statistics are even more grim: America’s Health Rankings from United Health Foundation found that Arizona’s suicide rate among 15 to 24 year olds is higher than the national average. Cronkite News will examine the rise of suicides, analyze the underlying societal, cultural, technological and medical causes behind the trend, explore how people are combating the problem and highlight initiatives that work elsewhere. This special project and in-depth coverage is made possible, in part, through a grant from the Arizona Community Foundation.</p>
        <br />
      </div>
    </div>
    ...
    <div class="large-3 medium-3 small-12 cell sp-stories-sm">
      <div class="single-story">
        <div class="image vignette">
          <img src="https://cronkitenews.azpbs.org/wp-content/uploads/2019/10/gunsmaloney-800.jpg" />
        </div>
        <a href="https://cronkitenews.azpbs.org/2019/10/21/report-phoenix-sixth-highest-metro-area-in-nation-for-gun-suicides/" target="_blank"><h6>Report: Phoenix sixth-highest metro area in nation for gun suicides</h6></a>
        <p>The Phoenix metro area had the sixth-highest rate of firearm suicides among the nation's urban areas, according to a new report by House Democrats tying the availability of guns to the prevalence of gun suicides. The report said there has been a steady increase in such deaths since 2000. <a class="read-more" href="https://cronkitenews.azpbs.org/2019/10/21/report-phoenix-sixth-highest-metro-area-in-nation-for-gun-suicides/" target="_blank">Read more</a></p>
      </div>
    </div>
