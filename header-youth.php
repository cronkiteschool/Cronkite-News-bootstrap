...
<header>
	 <nav class="navbar navbar-fixed-top" style="background-color:#2F4995;">
	...
	<a href='https://cronkitenews.azpbs.org/2017/08/04/youth-sports/'> <img src="https://cronkitenews.azpbs.org/wp-content/uploads/2017/07/Grad-Project-Headline-100x250.png" style="width:250px;height:100px;"></a>
<!--
	<div class="navbar-right">

	<button type="button" class="btn dropdown-toggle" id="ddmenubtn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#2F4995;margin-right:20px;">
...
-->
	  ...
	  <ul class="nav navbar-nav navbar-right" style="background-color:#2F4995;">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="https://cronkitenews.azpbs.org/2017/08/03/nutrition/">Nutrition</a></li>
			<li><a href="https://cronkitenews.azpbs.org/2017/08/03/childrens-fitness-levels-in-competitive-youth-sports/">Fitness</a></li>
			<li><a href="https://cronkitenews.azpbs.org/2017/08/03/sports-injury-heeds-new-start/">Injuries</a></li>
		 </ul>
		</li>
		   <li class="dropdown">
